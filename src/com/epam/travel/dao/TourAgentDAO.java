...
public interface TourAgentDAO {
     ...
     */
    int insertTourAgent(TourAgent tourAgent);
     ...
     */
    TourAgent findTourAgentByID(int id);
     ...
     * @return found tour agent.
     */
    TourAgent findTourAgentByEmail(String email);
     ...
     * @return found tour agent.
     */
    TourAgent[] findTourAgentsByName(String fullName);
     ...
     */
    boolean updateTourAgent(TourAgent tourAgent);
     ...
     * @return true if success and false otherwise.
     */
    boolean deleteTourAgent(int id);
}
